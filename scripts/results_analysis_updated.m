...
exp_language = {'data\gemini_flash_answers.mat', 'data\gemini_pro_answers.mat', 'data\gpt4o_answers.mat', 'data\gpt4_vision_answers.mat', 'data\claude_sonnet_answers.mat','data\claude_opus_answers.mat', 'data\siglip.mat'};
...
performance_language = performance_language*100;

vlm_0_cor = sum(performance_language(1,:))/numNetworks;
vlm_1_cor = sum(performance_language(2,:))/numNetworks;
vlm_2_cor = sum(performance_language(3,:))/numNetworks;

vlm_combined= (vlm_1_cor+vlm_2_cor)/2;
...
colors = {[250/255 37/255 119/255], [16/255 88/255 232/255], [160/255 10/255 201/255], [53/255 212/255 196/255]};
...
scatter(x_dummy_bar_1 + offset_left1, performance_language(1, 1), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', colors{1}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_1 + offset_center1, performance_language(1, 2), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);

scatter(x_dummy_bar_1, performance_language(1, 3), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', colors{2}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_1 + offset_right2, performance_language(1, 4), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);

scatter(x_dummy_bar_1 + offset_right1, performance_language(1, 5), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', colors{3}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_1 + offset_right1, performance_language(1, 6), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);

scatter(x_dummy_bar_1 + offset_right1, performance_language(1, 7), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{4}, 'MarkerFaceColor', colors{4}, 'LineWidth', LineWidth);

% ---- Plot diamonds for dummy bar 2 ---- %


scatter(x_dummy_bar_2 + offset_center1, performance_language(4, 1), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', colors{1}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_2 + offset_left2, performance_language(4, 2), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);


scatter(x_dummy_bar_2 + offset_center1, performance_language(4, 3), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', colors{2}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_2 + offset_center2, performance_language(4, 4), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);


scatter(x_dummy_bar_2 + offset_center1, performance_language(4, 5), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', colors{3}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_2 + offset_center2, performance_language(4, 6), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);
   

scatter(x_dummy_bar_2 + offset_center2, performance_language(4, 7), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{4}, 'MarkerFaceColor', colors{4}, 'LineWidth', LineWidth);
...
% ---- Plot diamonds for dummy bar 1 ---- %
scatter(x_dummy_bar_1 + offset_center1, performance_language(2, 1), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', colors{1}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_1 + offset_center2, performance_language(2, 2), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);

scatter(x_dummy_bar_1 + offset_center1, performance_language(2, 3), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', colors{2}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_1 + offset_center2, performance_language(2, 4), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);

scatter(x_dummy_bar_1 + offset_center1, performance_language(2, 5), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', colors{3}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_1 + offset_center2, performance_language(2, 6), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);

scatter(x_dummy_bar_1 + offset_center1, performance_language(2, 7), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{4}, 'MarkerFaceColor', colors{4}, 'LineWidth', LineWidth);

% ---- Plot diamonds for dummy bar 2 ---- %


scatter(x_dummy_bar_2 + offset_center1, performance_language(3, 1), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', colors{1}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_2 + offset_center2, performance_language(3, 2), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{1}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);


scatter(x_dummy_bar_2 + offset_center1, performance_language(3, 3), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', colors{2}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_2 + offset_center2, performance_language(3, 4), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{2}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);


scatter(x_dummy_bar_2 + offset_center1, performance_language(3, 5), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', colors{3}, 'LineWidth', LineWidth);
scatter(x_dummy_bar_2 + offset_center2, performance_language(3, 6), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{3}, 'MarkerFaceColor', 'none', 'LineWidth', LineWidth);


scatter(x_dummy_bar_2 + offset_center2, performance_language(3, 7), diamondSize, ...
        'd', 'MarkerEdgeColor', colors{4}, 'MarkerFaceColor', colors{4}, 'LineWidth', LineWidth);
